    ...
    JUnitXmlReporter.prototype = {
        ...
        reportSuiteResults: function(suite) {
            ...
            suite.output = '\n<testsuite name="' + this.getFullName(suite) +
                ...
                '" time="' + suite.getDuration() + '" timestamp="' + ISODateString(suite.startTime) + '">';
        ...
        reportRunnerResults: function(runner) {
            ...
            for (var i = 0; i < suites.length; i++) {
                ...
                if (this.consolidate && suite.parentSuite) {
                    ...
                    output += "\n</testsuites>";
                    var result = this.writeFile(this.savePath + fileName, output);
                    if (WinJS != undefined) {
                        winJSPromises.push(result);
                    }
                }
                else {
                    output += suite.output;
